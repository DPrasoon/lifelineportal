...
<title>Admin | Delete Donors</title>
...
<body>
	...
	<form method="post" action="/lifelineportal/DeleteDonors">
		...
		<table class="table table-danger table-striped">
			...
			<tbody>
				<%
				while (rs.next()) {
					String id = rs.getString("donor_id"); //selecting donors by their id
				%>
				<tr>
					<th><input type="checkbox" name="chkdonors" value="<%=id%>"></th>
